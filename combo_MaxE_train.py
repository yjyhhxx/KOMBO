...
# # ==================== 模型定义 ====================
class Combo_MaxE_Regressor(nn.Module):
    """4层神经网络回归模型"""
    def __init__(self, input_size):
        super(Combo_MaxE_Regressor, self).__init__()
    ...
    for epoch in range(Config.NUM_EPOCHS):
        ...
        if avg_val_loss < best_val_loss:
            ...
            model_save_path = os.path.join(
                ...
                f"Combo_MaxE_best_model_seed_{seed}.pth"
            )
...
def main():
    ...
    for seed in Config.RANDOM_SEEDS:
        ...
        model = Combo_MaxE_Regressor(X_train.shape[1]).to(Config.DEVICE)
    ...
    output_path = os.path.join(Config.OUTPUT_DIR, "Ours_combo_MaxE_result.csv")
